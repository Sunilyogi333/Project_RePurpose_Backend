...
router.get('/:productId', (0, authentication_middleware_1.default)([enum_1.ROLE.ADMIN, enum_1.ROLE.MEMBER, enum_1.ROLE.SELLER]), Request_Validator_1.default.validate(chat_dto_1.GetMessagesDTO), (0, catchAsync_1.catchAsync)(iocChatController.getMessagesForProduct.bind(iocChatController)));
router.all('/*', (req, res) => {
