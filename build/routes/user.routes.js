...
router.get('/', (0, authentication_middleware_1.default)([enum_1.ROLE.ADMIN, enum_1.ROLE.SELLER, enum_1.ROLE.STORE]), (0, catchAsync_1.catchAsync)(iocUserController.allUsers.bind(iocUserController)));
router.all('/*', (req, res) => {
