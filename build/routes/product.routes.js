...
router.get('/:id', (0, authentication_middleware_1.default)([enum_1.ROLE.ADMIN, enum_1.ROLE.SELLER, enum_1.ROLE.MEMBER]), (0, catchAsync_1.catchAsync)(productController.getProduct.bind(productController)));
